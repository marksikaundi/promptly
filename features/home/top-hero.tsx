      ...
      <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
        <div className="space-y-8">
          <div className="space-y-6">
            <a
              href="#watch-demo"
              className="inline-flex items-center text-sm font-medium text-[#2D1537] hover:text-[#2D1537]"
            >
            ...
            {features.map((feature, index) => (
              <li key={index} className="flex items-center gap-3">
                <div className="rounded-full p-1 bg-emerald-100">
                  <Check className="w-4 h-4 text-[#2D1537]" />
                </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-full max-w-[400px]">
                <div className="grid grid-cols-3 gap-4">
                  {[
                    "/socials/1.svg?height=120&width=120",
                    "/socials/2.svg?height=120&width=120",
                    "/socials/3.svg?height=120&width=120",
                    "/socials/4.svg?height=120&width=120",
                  ].map((icon, index) => (
                    <Image
                      key={index}
                      src={icon}
